...
MAX_PACKET_SIZE = 1500  # with an UDP header and my header
MAX_RAW_DATA_SIZE = 1487  # bytes for a raw data (without headers)
HEADER_FORMAT = '=IB'   # I - for a packet order, B - for a flag
PACKETS_PACK_SIZE = 10
HEADER_ULTIMATE_SIZE = 13  # 13 because of 8B UDP header, 5B my header
